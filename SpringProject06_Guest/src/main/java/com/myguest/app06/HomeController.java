...
public class HomeController {
	 ...
	 * @GetMapping("view")
	 * 
	 * @ResponseBody public String view(int num) { GuestVO guest =
	 * service.findByNum(num); JSONObject obj = new JSONObject(); obj.put("name",
	 * guest.getName()); obj.put("num", guest.getNum()); obj.put("content",
	 * guest.getContent()); obj.put("grade", guest.getGrade()); obj.put("created",
	 * guest.getCreated()); obj.put("ipaddr", guest.getIpaddr()); return
	 * obj.toJSONString();
	 * 
	 * }
	 */
